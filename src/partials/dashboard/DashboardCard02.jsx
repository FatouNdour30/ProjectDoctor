      ...
      <div className="px-5 pt-5">
        <header className="flex justify-between items-start mb-2">
          ...
          <EditMenu align="right" className="relative inline-flex">
            ...
            <li>
              <Link className="font-medium text-sm text-warning hover:text-rose-600 flex py-1 px-3" to="#0">
                Remove
              </Link>
            </li>
          </EditMenu>
        </header>
        <h2 className="text-lg font-semibold text-warning dark:text-slate-100 mb-2 text-center">Progression</h2>
